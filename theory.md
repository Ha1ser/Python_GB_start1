...
```Python
from modul import * # импортируем все из файла modul
print(max1(10, 9))
```
...
* **Быстрая сортировка** — Быстрая сортировка принадлежит такой стратегии, как “разделяй и властвуй”. Сначала
рассмотрим пример, затем напишем программный код

* **Сортировка слиянием** — ![сорт сли](12345.png)
